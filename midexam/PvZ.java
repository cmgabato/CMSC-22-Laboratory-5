...
public class PvZ {
    ...
    private Zombie getZombie(int row, int col) {
        ...
        if (lawn[row][col] instanceof Zombie) {
            ...
            Zombie dead = (Zombie) lawn[row][col];      //NOT SURE
            return dead;
        }
        return null;
    }
    ...
    public List<Producer> getProducerPlants() {
        ...
        for (Character[] col : lawn) {
            ...
            for (Character chr : col) {
                // TODO get all Producer plants on the lawn...  //DONE
                if(chr instanceof Sunflower){
                    Sunflower sun = (Sunflower) chr;
                    producers.add(sun);
                    sunlight += sun.produce();
                }
            }
        }
        return producers;
    ...
    public List<Plant> getPlantsOnRow(int row) {
        ...
        for (Character chr : lawn[row]) {
            ...
            if(chr instanceof Peashooter)
                attackers.add((Peashooter) chr);               //UNSURELY DONE!
        }
        return attackers;
    }
