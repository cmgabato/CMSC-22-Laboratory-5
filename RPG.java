...
public class RPG {
    ...
    public String getRandomMonsterName() {
        ...
        String[] monsters = {"O-GENESIS", "TOXYT-OCIN", "NITROM"};
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            if(choice1 == 2){
                ...
                if(choice2 == 1) name = "BRAWLER " + name;
                if(choice2 == 2) name = "ARCHER " + name;
                if(choice2 == 3) name = "SHAMAN " + name;

                String[] school = {"MYSTIC PEAK", "SACRED GATE", "HIPPO CAMPUS"};
                do{
                    int mons = rpg.randInt(1,3);
                    if (mons == 1){
                        villain = new Monster(rpg.getRandomMonsterName()+" of Pen-dora", 120+(level*5), 0, 10+(level*5));
                    }
                    if (mons == 2){
                        villain = new Monster(rpg.getRandomMonsterName()+" of NApple-eon", 100+(level*5), 0, 15+(level*5));
                    }
                    if(mons == 3){
                        villain = new Monster(rpg.getRandomMonsterName()+" of Ananass Confucius", 80+(level*5), 0, 20+(level*5));
                    }
                    System.out.println("\n~~~~~~~~~~~~~~~~~~~~~oOo~~~~~~~~~~~~~~~~~~~~oOo~~~~~~~~~~~~~~~~~~~");
                    ...
                    if (choice2  == 1){
                        hero = new Brawler(name, 90+(level-1)*5, 0, level);
                        System.out.println("Name: "+hero.getName()+"\nAcademy: "+school[choice2-1]+"\nHP: "+hero.getHp()+"\nMANA: "+hero.getMana()+"\nLevel: "+level);
                    }
                    if (choice2 == 2){
                        hero = new Archer(name, 80+(level-1)*5, 1, level);
                        System.out.println("Name: "+hero.getName()+"\nAcademy: "+school[choice2-1]+"\nHP: "+hero.getHp()+"\nMANA: "+hero.getMana()+"\nLevel: "+level); 
                    }
                    if (choice2 == 3){
                        hero = new Shaman(name, 100+(level-1)*5, 2, level);
                        System.out.println("Name: "+hero.getName()+"\nAcademy: "+school[choice2-1]+"\nHP: "+hero.getHp()+"\nMANA: "+hero.getMana()+"\nLevel: "+level); 
                    }       
                    System.out.printf("\n%s", villain);
                    ...
                    while (true) {
                        ...
                        do{
                            pwr = sc.nextInt();
                            if(pwr<1 || pwr>2) {System.out.println("ERROR 123: INPUT_INVALID");}
                        }while(pwr<1 || pwr>2);   
                        ...
                        System.out.printf("\n%s Mana: %d Level: %d\n%s", hero, hero.getMana(), level, villain);
                        ...
                        if(hero.manaFull() == false) {hero.setMana(hero.getMana()+2);}
                    }

                    System.out.printf("%s Mana: %d Level: %d\n%s\n", hero, hero.getMana(), level, villain);
